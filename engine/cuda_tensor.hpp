...
struct CUDATensor : public TransformerComputing {
    ...
    ComputingReturn op_rotary_embed(tensor_t self, tensor_t cached, tensor_t mask, tensor_t y) override;
    ...
    ComputingReturn op_sampling_top_p(tensor_t self, tensor_t mask, tensor_t output, float temp, float top_p) override;
